<?php
// HTTP
define('HTTP_SERVER', 'http://cummins-yar.ru/admin/');
define('HTTP_CATALOG', 'http://cummins-yar.ru/');

// HTTPS
define('HTTPS_SERVER', 'http://cummins-yar.ru/admin/');
define('HTTPS_CATALOG', 'http://cummins-yar.ru/');
